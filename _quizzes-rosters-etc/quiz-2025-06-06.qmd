...
`r Q()`  Consider the time series $x(t) = \sin(t)$ as a **candidate** solution starting at the initial condition $(x = 0, y = 1)$. Use anti-differentiation to find the corresponding $y(t)$.

`r vspace(1)`

`r Q()` Modify the differential equations so that $x(t) = A \sin(\omega t)$ and its corresponding $y(t)$ are solutions, where $\omega$ describes the frequency of the oscillation. Write the modified equations here.
